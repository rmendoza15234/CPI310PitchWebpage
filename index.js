...
app.get("/", async (req, res) => {
    ...
    res.render("home", { user: req.user }); //renders the messages and user to the home page
});
...
app.get("/forum", async (req, res) => {
    ...
    res.render("forum", { messages: messages, user: req.user }); //renders the messages and user to the home page
});
